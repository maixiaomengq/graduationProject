...
<script type="text/javascript" src="/thinkphp_3.2.3_full/Public/js/faculty.js"></script> 
<!--[if IE 6]>
...
<article class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/Clubmember/member_con/id/11" method="post"  enctype="multipart/form-data" >
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tr class="text-c">
			<th width="40">学号</th>
			<th width="40"><input type="text" class="input-text" value="<?php echo ($current["stu_number"]); ?>" placeholder="" id="stu_number" name="stu_number" readonly></th>

			<th width="40">院系</th>
			<th width="40">
			<input type="text" class="input-text" value="<?php echo ($current["member_yuanxi"]); ?>" placeholder="" id="member_yuanxi" name="member_yuanxi" readonly>
			</th>				
			<th width="10"  rowspan="5">头像</th>
			<th width="40"  rowspan="5">
				<div class="am-form-group">  
        		<div id="imgPreview" class="am-u-sm-4 am-u-sm-centered am-u-end">  
            		<img id="img1" src="/thinkphp_3.2.3_full/Public/uploads/member/<?php echo ($current["member_logo"]); ?>" alt="" width="150" height="150"/><!-- 显示缩略图 -->  
        		</div>   
    		</div> 
			</th>
		</tr>
		<tr class="text-c">
			...
			<th width="40">专业-班级</th>
			<th width="40">
			<input type="text" class="input-text" value="<?php echo ($current["member_major"]); ?>-<?php echo ($current["member_class"]); ?>"" placeholder=""  readonly>
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">成员性别</th>
			...
			<th width="40">所在社团</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($current["member_club"]); ?>" placeholder="" id="member_club" name="member_club">
			</th>
		</tr>
		<tr class="text-c" >
			<th width="40">联系方式</th>
			...
			<th width="40">部门</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($current["member_depart"]); ?>" placeholder="" id="member_depart" name="member_depart">
			</th>
		</tr>
		...
		<tr class="text-c" >
			...
			<th width="40">职位</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($current["member_position"]); ?>" placeholder="" id="member_position" name="member_position">
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">政治面貌</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($current["member_politics"]); ?>" placeholder="" id="member_politics" name="member_politics">
			</th>
			<th width="40">入社时间</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($current["create_time"]); ?>" placeholder="" id="create_time" name="create_time">
			</th>
		</tr>
	</table>
	</form>
