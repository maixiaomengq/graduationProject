...
<title>审核 - H-ui.admin v3.1</title>
...
<article class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/Clubmember/apply_pass/id/<?php echo ($current["member_id"]); ?>" method="post"  enctype="multipart/form-data" >
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tr class="text-c">
			...
			<th width="40">院系专业</th>
			<th width="40">
			<select class="select" size="1" name="member_yuanxi">
			...
			<select class="select" size="1" name="member_major">
		...
		<tr class="text-c">
			...
			<th width="40">
				<select class="select" size="1" name="member_club">
					<option value="0" selected>---请选择社团---</option>
					<?php if(is_array($clublsit)): $i = 0; $__LIST__ = $clublsit;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$clublsit): $mod = ($i % 2 );++$i; if($clublsit['club_name'] == $current['member_club']): ?><option value="<?php echo ($clublsit["club_name"]); ?>" selected="selected" >
						<?php echo ($clublsit["club_name"]); ?>
						</option>
					<?php else: ?>
						<option value="<?php echo ($clublsit["club_name"]); ?>" ><?php echo ($clublsit["club_name"]); ?>
						</option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</th>
		</tr>
		...
		<tr  class="text-c">
			<th colspan="6">
			<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;通过审核&nbsp;&nbsp;">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a  href="/thinkphp_3.2.3_full/Home/Clubmember/apply_nopass/id/<?php echo ($current["member_id"]); ?>" class="btn btn-danger radius" class="ml-5" style="text-decoration:none" >未通过审核</a>
			</th>
		</tr>
	</table>
	</form>
