...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 物品管理 <span class="c-gray en">&gt;</span> 物品借出表<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<div class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/Goods/record_pldel" method="post"  enctype="multipart/form-data" >
...
<!-- 	<span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>  -->
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
		<?php if(is_array($recordlist)): $i = 0; $__LIST__ = $recordlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
				<td><input type="checkbox" value="<?php echo ($vo["lend_id"]); ?>" name="recordarray[]"></td>
				<td><?php echo ($i); ?></td>
				...
				<?php if($vo['return_status'] == 0): ?><td><span class="label label-secondary radius">待归还</span></td>
				<?php else: ?>
					<td><span class="label label-success radius">已归还</span></td>
				</elseif><?php endif; ?>
				<td class="td-manage">
				<a title="归还物品" href="javascript:;" onclick="member_edit('归还物品','/thinkphp_3.2.3_full/Home/Goods/return_goods/id/<?php echo ($vo["lend_id"]); ?>','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe620;</i></a>
					<a title="删除" href="/thinkphp_3.2.3_full/Home/Goods/record_del/id/<?php echo ($vo["lend_id"]); ?>" class="ml-5" style="text-decoration:none" onclick="return confirm('确定要删除吗？')">
