...
<script charset="utf-8" src="/thinkphp_3.2.3_full/Public/Uploads/kindeditor/kindeditor.js"></script>
<script charset="utf-8" src="/thinkphp_3.2.3_full/Public/Uploads/kindeditor/lang/zh_CN.js"></script>
<script>
...
<article class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/New/new_con/id/1" method="post"  enctype="multipart/form-data" >
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tr class="text-c">
			...
			<th width="40">部门名称</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($current["new_depart"]); ?>" placeholder="" id="new_depart" name="new_depart">
			</th>
		</tr>
		<tr class="text-c">
