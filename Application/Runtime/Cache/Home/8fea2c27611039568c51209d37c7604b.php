...
<article class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/Myclub/myclub_con/id/2" method="post"  enctype="multipart/form-data" >
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tr class="text-c">
			<th width="40">社团名称</th>
			<th width="40"><input type="text" class="input-text" value="<?php echo ($current["club_name"]); ?>" placeholder="" id="club_name" name="club_name" readonly></th>
			<th width="40">社团所在地</th>
			<th width="40">
			<input type="text" class="input-text" value="<?php echo ($current["club_location"]); ?>" placeholder="" id="club_location" name="club_location" readonly>
			</th>
		...
		<tr class="text-c">
			...
			<th width="40">
			<input type="text" class="input-text" value="<?php echo ($current["president_number"]); ?>" placeholder="" id="president_number" name="president_number" readonly>
			</th>
			<th width="40">社团成立日期</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($current["create_date"]); ?>" placeholder="" id="create_date" name="create_date" readonly>
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">现任会长姓名</th>
			<th width="40">
			<input type="text" class="input-text" value="<?php echo ($current["president_name"]); ?>" placeholder="" id="president_name" name="president_name" readonly>
			</th>
			<th width="40">指导老师</th>
			<th width="40">
			<input type="text" class="input-text" value="<?php echo ($current["teacher_name"]); ?>" placeholder="" id="teacher_name" name="teacher_name" readonly>
			</th>
		</tr>
		<tr class="text-c" >
			<th width="40">现任会长电话</th>
			<th width="40">
			<input type="text" class="input-text" value="<?php echo ($current["president_phone"]); ?>" placeholder="" id="president_phone" name="president_phone" readonly>
			</th>
			<th width="40">主管单位</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($current["club_organization"]); ?>" placeholder="" id="club_organization" name="club_organization" readonly>
			</th>
		</tr>
		<tr class="text-c" >
			<th width="40">创始人姓名</th>
			<th width="40">
			<input type="text" class="input-text" value="<?php echo ($current["create_name"]); ?>" placeholder="" id="create_name" name="create_name" readonly>
			</th>
			<th width="40">社团性质(类型)</th>
			<th width="40">
			<input type="text" class="input-text" value="<?php echo ($current["club_nature"]); ?>" placeholder="" id="club_nature" name="club_nature" readonly>
			</th>
			<th width="20"  rowspan="3">社团简介</th>
			<th width="40" rowspan="3">
			<textarea name="club_profile"  id="club_profile" cols="35" rows="8" readonly><?php echo ($current["club_profile"]); ?></textarea>
			</th>
		</tr>
		<tr class="text-c" >
