...
<article class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/Myclub/retired_apply/club_id/2" method="post"  enctype="multipart/form-data" >
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tr class="text-c">
			<th width="40">学号</th>
			<th width="40"><input type="text" class="input-text" value="<?php echo ($member_con["stu_number"]); ?>" placeholder="" id="stu_number" name="stu_number" readonly></th>
			<th width="40">姓名</th>
			<th width="40"><input type="text" class="input-text" value="<?php echo ($member_con["member_name"]); ?>" placeholder="" id="member_name" name="member_name" readonly></th>			

		</tr>
		<tr class="text-c" >
			<th width="40">所在社团</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($member_con["member_club"]); ?>" placeholder="" id="member_club" name="member_club" readonly>
			</th>
			<th width="40">部门</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($member_con["member_depart"]); ?>" placeholder="" id="retired_depart" name="retired_depart" readonly>
			</th>
		</tr>
		...
		<tr class="text-c" >
			<th width="40">入社时间</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($member_con["create_time"]); ?>" placeholder="" readonly>
			</th>
			<th width="40">职位</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($member_con["member_position"]); ?>" placeholder="" id="retired_position" name="retired_position" readonly>
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">退社理由</th>
			<th width="40" colspan="3">
				<textarea name="retired_reason" id="retired_reason"  rows="4" cols="60"></textarea>
			</th>
		</tr>
		<tr  class="text-c" align="center">
			<th colspan="6">
			<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;提交申请&nbsp;&nbsp;">
			</th>
		</tr>
	</table>
	</form>
