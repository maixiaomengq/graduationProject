...
<article class="page-container">
	...
	<form action="/Home/Auth/updateAuth/auth_id/52" method="post"  enctype="multipart/form-data" >
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tr class="text-c">
			<th width="40" >权限名称</th>
			<th width="40" >
			<input type="text" class="input-text" value="<?php echo ($current_auth["auth_name"]); ?>" placeholder="" id="auth_name" name="auth_name">
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">选中父级</th>
			...
			<option value="0" selected>---请选择父级---</option>
		...
		<tr class="text-c">
			<th width="40">控制器名称</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($current_auth["auth_c"]); ?>" placeholder="" id="auth_c" name="auth_c">
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">方法名称</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($current_auth["auth_a"]); ?>" placeholder="" id="auth_a" name="auth_a">
			</th>
		</tr>
