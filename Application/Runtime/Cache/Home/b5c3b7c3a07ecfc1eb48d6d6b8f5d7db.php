...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 社联信息管理 <span class="c-gray en">&gt;</span> 社联部门管理<span class="c-gray en">&gt;</span> 部门信息 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<div class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/Department/pl_del" method="post"  enctype="multipart/form-data" >
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
<!-- 	<span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>  -->
	<span class="l"><input type="submit" value="&#xe6e2;批量删除" class="btn btn-danger radius" >
	<a href="javascript:;" onclick="member_add('添加成员','/thinkphp_3.2.3_full/Home/Department/members_add','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加成员</a></span> 
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php if(is_array($memberlist)): $i = 0; $__LIST__ = $memberlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
				...
				<td><?php echo ($i); ?></td>
				<td><img src="/thinkphp_3.2.3_full/Public/uploads/<?php echo ($vo["member_logo"]); ?>"></td>
				...
				<td class="td-manage">
				<a title="修改" href="javascript:;" onclick="member_edit('修改','/thinkphp_3.2.3_full/Home/Department/members_update/id/<?php echo ($vo["member_id"]); ?>','4','','510')" class="ml-5" style="text-decoration:none">
					<i class="Hui-iconfont">&#xe6df;</i></a> 
<!-- 					<a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo ($vo["member_id"]); ?>')" class="ml-5" style="text-decoration:none">
					<i class="Hui-iconfont">&#xe6e2;</i></a> -->
					<a title="删除" href="/thinkphp_3.2.3_full/Home/Department/members_del/id/<?php echo ($vo["member_id"]); ?>" class="ml-5" style="text-decoration:none" onclick="return confirm('确定要删除吗？')">
					<i class="Hui-iconfont">&#xe6e2;</i></a>
				</td>
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '/thinkphp_3.2.3_full/Home/Department/members_del/id/<?php echo ($vo["member_id"]); ?>',
			dataType: 'json',
			success: function(data){
