...
<article class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/Goods/return_goods/id/9" method="post"  enctype="multipart/form-data" >
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<th colspan="4">
			<a href="/thinkphp_3.2.3_full/Home/Goods/return_pass/id/<?php echo ($current["lend_id"]); ?>" class="btn btn-primary radius" class="ml-5" style="text-decoration:none" >归还物品</a>
		</th>
		</tr>
	</table>
	</form>
