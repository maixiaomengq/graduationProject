...
<article class="page-container">
	...
	<form action="/Home/Clubmember/club_memberadd" method="post"  enctype="multipart/form-data" >
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tr class="text-c">
			...
			<th width="40">所在社团</th>
			<th width="40">
			<?php if($role_id == 1 or $role_id == 2): ?><select class="select" size="1" name="member_club">
			...
			<?php else: ?>
				<input type="text" class="input-text" value="<?php echo ($club_name); ?>" placeholder="" id="member_club" name="member_club" readonly><?php endif; ?>	
			</th>
