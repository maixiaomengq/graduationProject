...
<link rel="stylesheet" type="text/css" href="/thinkphp_3.2.3_full/Public/static/h-ui.admin/css/style.css" />
 <script src="/thinkphp_3.2.3_full/Public/ueditor/ueditor.config.js"></script>
 <script src="/thinkphp_3.2.3_full/Public/ueditor/ueditor.all.min.js"></script>
 <script src="/thinkphp_3.2.3_full/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
<!--[if IE 6]>
...
<article class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/System/system_update/id/7" method="post"  enctype="multipart/form-data" >
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tr class="text-c">
			<th width="40"  >社团
			</th>
			<th width="40" colspan="3">
			<input type="text" class="input-text" value="<?php echo ($current["system_club"]); ?>" placeholder="" id="system_club" name="system_club">
			</th>
		</tr>
		<tr class="text-c">
			<th width="40" >发布者姓名
			...
			<th width="40">
			<input type="text" class="input-text" value="<?php echo ($current["system_stu"]); ?>" placeholder="" id="system_stu" name="system_stu">
			</th>
			<th width="40" >发布者学号
			</th>
			<th width="40">
			<input type="text" class="input-text" value="<?php echo ($current["system_number"]); ?>" placeholder="" id="system_number" name="system_number">
			</th>
		</tr>
		<tr class="text-c">
			<th width="40"  >制度内容
		...
		<tr  class="text-c" align="center">
			<th colspan="4" >
			<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;修改制度&nbsp;&nbsp;">
			</th>
		</tr>
	</table>
	</form>
