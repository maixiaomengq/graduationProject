...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 物品管理 <span class="c-gray en">&gt;</span> 物品购置表<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<div class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/Goods/buy_pldel" method="post"  enctype="multipart/form-data" >
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
<!-- 	<span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>  -->
	<span class="l"><input type="submit" value="&#xe6e2;批量删除" class="btn btn-danger radius" >
	<a href="javascript:;" onclick="member_add('添加物品','/thinkphp_3.2.3_full/Home/Goods/buy_add','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加购置物品记录</a></span> 
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
		<?php if(is_array($buylist)): $i = 0; $__LIST__ = $buylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
				<td><input type="checkbox" value="<?php echo ($vo["buy_id"]); ?>" name="buyarray[]"></td>
				<td><?php echo ($i); ?></td>
				<td><?php echo ($vo["goods_bh"]); ?></td>
				<td><?php echo ($vo["buy_name"]); ?></td>
				<td><?php echo ($vo["buy_number"]); ?></td>
				<td><?php echo ($vo["buy_time"]); ?></td>
				<td><?php echo ($vo["buy_stu"]); ?></td>
				<td><?php echo ($vo["buy_telephone"]); ?></td>
				<td><?php echo ($vo["place"]); ?></td>
				<td class="td-manage">
				<a title="修改" href="javascript:;" onclick="member_edit('修改','/thinkphp_3.2.3_full/Home/Goods/buy_update/id/<?php echo ($vo["buy_id"]); ?>','4','','510')" class="ml-5" style="text-decoration:none">
					<i class="Hui-iconfont">&#xe6df;</i></a> 
					<a title="删除" href="/thinkphp_3.2.3_full/Home/Goods/buy_del/id/<?php echo ($vo["buy_id"]); ?>" class="ml-5" style="text-decoration:none" onclick="return confirm('确定要删除吗？')">
					<i class="Hui-iconfont">&#xe6e2;</i></a>
				</td>
