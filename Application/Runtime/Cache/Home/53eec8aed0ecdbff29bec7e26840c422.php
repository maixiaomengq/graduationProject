...
<article class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/Goods/buy_add" method="post"  enctype="multipart/form-data" >
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tr class="text-c">
			<th width="40" >物品编号</th>
			<th width="40" colspan="3" >
			<select name="goods_bh" id="goods_bh">
			<option value="" selected>---请选择物品编号---</option>
			<?php if(is_array($bh)): $i = 0; $__LIST__ = $bh;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["goods_bh"]); ?>"><?php echo ($vo["goods_bh"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">物品名称</th>
			<th width="40">
				<input type="text" class="input-text" value="" placeholder="" id="buy_name" name="buy_name">
			</th>
			<th width="40">物品数量</th>
			<th width="40">
				<input type="text" class="input-text" value="" placeholder="" id="buy_number" name="buy_number">
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">购置时间</th>
			<th width="40">
				<input type="text" class="input-text" value="" placeholder="" id="buy_time" name="buy_time">
			</th>
			<th width="40">购置人</th>
			<th width="40">
				<input type="text" class="input-text" value="" placeholder="" id="buy_stu" name="buy_stu">
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">联系电话</th>
			<th width="40">
				<input type="text" class="input-text" value="" placeholder="" id="buy_telephone" name="buy_telephone">
			</th>
			<th width="40">购置地点</th>
			<th width="40">
