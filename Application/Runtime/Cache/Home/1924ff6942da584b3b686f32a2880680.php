...
<article class="page-container">
	...
	<form action="/thinkphp_3.2.3_full/Home/Goods/lend_apply/id/4" method="post"  enctype="multipart/form-data" >
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tr class="text-c">
			<th width="40" >物品编号</th>
			<th width="40" colspan="3" >
				<input type="text" class="input-text" value="<?php echo ($current["goods_bh"]); ?>" placeholder="" id="goods_bh" name="goods_bh" readonly="readonly">
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">物品名称</th>
			<th width="40">
				<input type="text" class="input-text" value="<?php echo ($current["goods_name"]); ?>" placeholder="" id="lend_name" name="lend_name" readonly="readonly">
			</th>
			<th width="40">借出数量</th>
			<th width="40">
				<input type="text" class="input-text" value="" placeholder="" id="lend_number" name="lend_number">
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">社团名称</th>
			<th width="40">
				<input type="text" class="input-text" value="" placeholder="" id="lend_club" name="lend_club">
			</th>
			<th width="40">借出时间</th>
			<th width="40">
				<input type="text" class="input-text" value="" placeholder="" id="lend_time" name="lend_time">
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">归还时间</th>
			<th width="40">
				<input type="text" class="input-text" value="" placeholder="" id="return_time" name="return_time">
			</th>
			<th width="40">借出人</th>
			<th width="40">
				<input type="text" class="input-text" value="" placeholder="" id="lend_stu" name="lend_stu">
			</th>
		</tr>
		<tr class="text-c">
			...
			<th width="40">
				<input type="text" class="input-text" value="" placeholder="" id="lend_telephone" name="lend_telephone">
			</th>
		</tr>
		<tr class="text-c">
			<th width="40">借出理由</th>
			<th width="40" colspan="3">
				<textarea name="lend_reason" id="lend_reason" rows="5" cols="50"></textarea>
			</th>
		</tr>

		<tr  class="text-c" align="center">
			<th colspan="4">
			<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;申请借出物品&nbsp;&nbsp;">
			</th>
		</tr>
	</table>
	</form>
