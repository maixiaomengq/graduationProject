...
<article class="page-container">
	...
	<form action="/Home/Myclub/myclub_update/id/1" method="post"  enctype="multipart/form-data" >
		...
		<tr class="text-c">
			...
			<div class="am-form-group">  
        		<div id="imgPreview" class="am-u-sm-4 am-u-sm-centered am-u-end">  
            		<img id="img1" src="/Public/uploads/logos/<?php echo ($current["club_logo"]); ?>" alt="" width="150" height="150"/><!-- 显示缩略图 -->  
        		</div>   
    		</div> 
			</th>
		</tr>
